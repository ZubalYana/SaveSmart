...
function AuthLayout() {
  ...
  return (
    <div className='AuthLayout w-full h-full p-8 xl:p-4'>
      ...
      <div className="AuthLayout_content w-full h-full flex flex-col items-center">
        <h1 className='text-5xl font-bold text-defaultText mb-2 xl:text-3xl xl:mt-3'>Hello there!</h1>
        <p className='text-base font-normal text-defaultText w-[850px] text-center xl:w-full xl:text-xs'>
        ...
        <div className="AuthLayout_cards w-[870px] flex justify-between mt-10 xl:w-full xl:flex-col">
          <AuthLayoutCard
            title="I’m back here!"
